...
public class DisplayHelper {
    ...
    /**
     * either add spaces or trim the input string to fit into a new
     * string of the given side. Right Justify
     *
     * @param input
     * @param width
     * @return
    ...
    public static String fitIntoRight(String input, int width) {
        ...
        return StringUtils.leftPad(trimmed, width);
    }

    /**
     * either add spaces or trim the input string to fit into a new
     * string of the given side. Left Justify
     *
     * @param input
     * @param width
     * @return
    ...
    public static String fitIntoLeft(String input, int width) {
        String trimmed = StringUtils.left(input, width);
        return StringUtils.rightPad(trimmed, width);
    }

    /**
     * @param text    the text to surrond
     * @param pattern the top and bottom border pattern to use
     * @param side    the character to put on the left and right
     * @param size    the overall length of the box
     */
    public static String create3RowSurroundBox(String text, String pattern, char side, int size) {
        StringBuilder b = new StringBuilder(size * 3);
    ...
    /**
     * size < 3 will return an empty string
     * text will be truncated to fit size
     *
     * @param text
     * @param side
     * @param size
    ...
    public static String repeatedPatternLine(String pattern, int size) {
        ...
        StringBuilder b = new StringBuilder(numberToUse * patternSize);
